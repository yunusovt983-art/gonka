...
import (
	...
	streamvestingsimulation "github.com/productscience/inference/x/streamvesting/simulation"
	"github.com/productscience/inference/x/streamvesting/types"
)

// avoid unused import issue
var (
	_ = streamvestingsimulation.FindAccount
	_ = rand.Rand{}
	_ = sample.AccAddress
	_ = sdk.AccAddress{}
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	streamvestingGenesis := types.GenesisState{
