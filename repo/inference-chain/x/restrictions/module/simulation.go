...
import (
	...
	restrictionssimulation "github.com/productscience/inference/x/restrictions/simulation"
	"github.com/productscience/inference/x/restrictions/types"
)

// avoid unused import issue
var (
	_ = restrictionssimulation.FindAccount
	_ = rand.Rand{}
	_ = sample.AccAddress
	_ = sdk.AccAddress{}
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	restrictionsGenesis := types.GenesisState{
