...
import (
	...
	bookkeepersimulation "github.com/productscience/inference/x/bookkeeper/simulation"
	"github.com/productscience/inference/x/bookkeeper/types"
)

// avoid unused import issue
var (
	_ = bookkeepersimulation.FindAccount
	_ = rand.Rand{}
	_ = sample.AccAddress
	_ = sdk.AccAddress{}
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	bookkeeperGenesis := types.GenesisState{
