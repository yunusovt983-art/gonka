...
import (
	...
	genesistransfersimulation "github.com/productscience/inference/x/genesistransfer/simulation"
	"github.com/productscience/inference/x/genesistransfer/types"
)

// avoid unused import issue
var (
	_ = genesistransfersimulation.FindAccount
	_ = rand.Rand{}
	_ = sample.AccAddress
	_ = sdk.AccAddress{}
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	genesistransferGenesis := types.GenesisState{
